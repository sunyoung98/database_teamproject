	...
	<body>
		...
		<nav class="navbar navbar-default">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="bbs_stu.jsp">게시판</a></li>
					<li><a href="enrollment.jsp">수강 신청</a></li>
		...
		<!-- 게시판 -->
		<div>
			<form class= "qb" method="post" action="bbsAction2.jsp">
				<select name="subjects"  style=" margin-left:85px;margin-bottom: 10px; width:180px;" >
					...
					<%
						...
						ArrayList<Bbs> p = stu_subjects.getSubjects(userID);
				...
				<table class="table table-striped"
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="view_stu.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle()%></a></td>
